...
`ffc` manages observability first. It does not consider a running daemon sufficient: enabled status, panic state, configured exposure, forwarding, masquerading, and permanent/runtime drift are all reported.
