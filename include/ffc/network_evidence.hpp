...
class NetworkEvidenceRecorder {
public:
    NetworkEvidenceRecorder(const NetworkMetadataInspector& metadata, const NetworkHistoryStore& history) : metadata_(metadata), history_(history) {}
...
using NetworkEvidenceService = NetworkEvidenceRecorder; // Compatibility name for early integrations.
} // namespace ffc
